    ...
    <Container>
      <Header className="me">
        <AppName>
          ...
          {/* reciper  */}
          {/* <ul className="ul">
         <li className="li"> <Link style={{color:'white',textDecoration:'none'}} to="about">About</Link></li></ul>
         <ul className="ul">
    <li className="li"><Link style={{color:'white',textDecoration:'none'}} to="contact">Contact</Link></li>  
    </ul> */}
        </AppName>
        <SearchBox>
